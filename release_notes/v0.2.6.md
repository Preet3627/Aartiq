...
### Token Storage Keys
- `aartiq_auth_user_id` - Firebase UID
- `aartiq_auth_user_email` - User email
- `aartiq_auth_user_name` - Display name
- `aartiq_auth_user_photo` - Profile photo URL
- `aartiq_auth_id_token` - Firebase ID token

### Deep Link Support
| Deep Link | Purpose |
|-----------|---------|
| `aartiq://auth` | Open auth page |
| `aartiq://connect` | Connect desktop page |
| `aartiq://chat?message=...` | Open AI chat with message |
