...
class RaycastIntegration {
  ...
  async handleChat(params) {
    ...
    return {
      ...
      action: 'chat',
      message,
      aiResponse: 'Message sent to AI. Check Comet AI for response.'
    };
  }
  ...
  async handleCreatePdf(params) {
    ...
    return {
      ...
      message: 'PDF creation request sent to Comet AI'
    };
  }
  ...
  async handleSchedule(params) {
    ...
    return {
      ...
      task,
      cron: cron || '0 9 * * *',
      message: 'Task scheduled in Comet AI'
    };
  }
  ...
  async handleAsk(params) {
    ...
    return {
      ...
      prompt,
      speak: speak === 'true',
      message: 'AI query sent to Comet AI'
    };
  }
  ...
  getManifest() {
    return {
      ...
      version: '1.0.0',
      description: 'Comet AI Raycast Integration',
      endpoints: {
