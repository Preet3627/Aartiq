  ...
  professional: (title, content, iconBase64, metadata = {}) => `
    <html>
      <head>
        <meta charset="utf-8">
        <style>
          @page { margin: 60px 50px 80px 50px; }
          body { font-family: 'Helvetica', sans-serif; padding: 0; color: #333; line-height: 1.6; }
          ...
          .content pre, .content code { page-break-inside: avoid; }
          .content img { page-break-inside: avoid; }
          .footer { position: fixed; bottom: 0; left: 0; right: 0; height: 60px; text-align: center; font-size: 10px; color: #9CA3AF; border-top: 1px solid #E5E7EB; padding-top: 10px; }
          table { width: 100%; border-collapse: collapse; margin: 20px 0; }
          th { background: #F3F4F6; text-align: left; padding: 10px; border: 1px solid #E5E7EB; }
          td { padding: 10px; border: 1px solid #E5E7EB; }
          blockquote { border-left: 4px solid #4F46E5; padding-left: 15px; font-style: italic; color: #4B5563; margin: 20px 0; }
        ...
        <div class="header">
          ...
          <div class="title-area">
            ...
            <div class="metadata">
              ...
              <span>Generated by Aartiq on ${new Date().toLocaleDateString()}</span>
            </div>
          </div>
        </div>
        <div class="content">${content}</div>
        <div class="footer">Generated by Aartiq</div>
      </body>
    </html>
  `
};
