      ...
      <head>
        ...
        <style>
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .footer { margin-top: 40px; padding-top: 16px; border-top: 1px solid #eee; display: flex; justify-content: space-between; align-items: center; font-size: 0.75rem; color: #aaa; }
        </style>
      </head>
      <body>
        <div class="header">
