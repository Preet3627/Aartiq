...
function generateVoiceTriggerScript() {
  return `# Aartiq Voice Trigger - macOS Automation
...
# Step 3: Send to Aartiq
if dictatedText is not "" then
    tell application "Aartiq"
        activate
        open location "aartiq://chat?message=" & dictatedText
    end tell
end if
`;
}
...
function generateContinuousVoiceScript() {
  return `# Aartiq Continuous Voice Listening
