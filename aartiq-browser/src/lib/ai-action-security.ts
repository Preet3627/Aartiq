...
export const AI_ACTION_SECURITY_CATALOG: AIActionSecurityDefinition[] = [
  ...
  },
  {
    ...
    category: 'System',
    risk: 'medium',
    detail: 'Can expose sensitive data if used without awareness.',
    toggleable: true,
  },
  {
    actionType: 'DOWNLOAD_FILE',
    label: 'Download files',
    description: 'Save files from the web to local disk.',
    category: 'Files',
    risk: 'medium',
    detail: 'Downloads files that may require user review.',
    toggleable: true,
  },
  {
    actionType: 'WRITE_FILE',
    label: 'Write or create files',
    description: 'Create or overwrite files on the local filesystem.',
    category: 'Files',
    risk: 'medium',
    detail: 'Modifies local files outside the browser sandbox.',
    toggleable: true,
  },
  {
