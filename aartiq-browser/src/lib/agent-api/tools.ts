...
const str = (desc: string, extra: Record<string, any> = {}) => ({ type: 'string', description: desc, ...extra });
...
const SECURITY: Tool[] = [
  ...
  t({
    ...
    async handler(_a, ctx) { return jsonResult(ctx.security.origin.getAuditLog()); },
  }),
  t({
    ...
    async handler(args, ctx) { ctx.security.origin.setKillSwitch(!!args.engaged); return textResult(`Kill switch ${args.engaged ? 'engaged' : 'released'}.`); },
  }),
  t({
    name: 'trust_list', category: 'Security', description: 'List registered agents and their trust levels.',
    inputSchema: { type: 'object', properties: {} }, annotations: { readOnlyHint: true },
    async handler(_a, ctx) { return jsonResult(ctx.agents.trust.list()); },
  }),
];
...
const AGENTS: Tool[] = [
  t({
    ...
    async handler(args, ctx) { return jsonResult(ctx.agents.connect(args)); },
  }),
  t({
    name: 'agent_list', category: 'Agents', description: 'List currently connected agents.',
    inputSchema: { type: 'object', properties: {} }, annotations: { readOnlyHint: true },
    async handler(_a, ctx) { return jsonResult(ctx.agents.connectedAgents()); },
  }),
  t({
    ...
    async handler(args, ctx) { ctx.agents.disconnect(args.agentId); return textResult(`Agent ${args.agentId} revoked.`); },
  }),
  t({
    ...
    async handler(args, ctx) { const r = ctx.agents.locks.handoff(args.tabId, args.fromAgentId, args.toAgentId); return jsonResult(r); },
  }),
];
...
const SNAPSHOTS: Tool[] = [
  t({
    ...
    async handler(args, ctx) { const r = await ctx.bridge.call('snapshot', args); ctx.snapshots.reset(); return jsonResult(r); },
  }),
  t({
    ...
    async handler(args, ctx) { return jsonResult(await ctx.bridge.call('clickRef', args)); },
  }),
  t({
    ...
    async handler(args, ctx) { return jsonResult(await ctx.bridge.call('fillRef', args)); },
  }),
  t({
    ...
    async handler(args, ctx) { return jsonResult(await ctx.bridge.call('typeRef', args)); },
  }),
];
...
const FORMS: Tool[] = [
  t({
    ...
    async handler(args, ctx) { return jsonResult(await ctx.bridge.call('autofillMatch', args)); },
  }),
  t({
    name: 'vault_list', category: 'Forms', description: 'List stored credentials and identity profiles (values redacted).',
    inputSchema: { type: 'object', properties: {} }, annotations: { readOnlyHint: true },
    async handler(_a, ctx) { const v = await ctx.bridge.call('vaultList'); return jsonResult(v); },
  }),
  t({
    ...
    async handler(_a, ctx) { return jsonResult(await ctx.bridge.call('vaultUnlock')); },
  }),
];
...
const EXTENSIONS: Tool[] = [
  t({
    ...
    inputSchema: { type: 'object', properties: {} }, annotations: { readOnlyHint: true },
    async handler(_a, ctx) { return jsonResult(await ctx.bridge.call('extensionList')); },
  }),
  t({
    ...
    async handler(args, ctx) { return jsonResult(await ctx.bridge.call('extensionInstallWebStore', args)); },
  }),
  t({
    ...
    async handler(args, ctx) { return jsonResult(await ctx.bridge.call('extensionImportChrome', args)); },
  }),
  t({
    ...
    async handler(args, ctx) { return jsonResult(await ctx.bridge.call('extensionAnalyze', args)); },
  }),
];
...
const THEME: Tool[] = [
  t({
    ...
    inputSchema: { type: 'object', properties: {} }, annotations: { readOnlyHint: true },
    async handler(_a, ctx) { return jsonResult(await ctx.bridge.call('themeResolve')); },
  }),
  t({
    ...
    async handler(args, ctx) { ctx.bridge.call('themeResolve'); return textResult(`UI mode set to ${args.mode}.`); },
  }),
];
...
const NAVIGATION: Tool[] = [
  t({
    ...
    async handler(args, ctx) { await ctx.bridge.call('navigate', args); ctx.snapshots.reset(); return textResult(`Navigated ${args.tabId} to ${args.url}.`); },
  }),
  t({
    ...
    async handler(args, ctx) { return jsonResult(await ctx.bridge.call('getPageText', args)); },
  }),
];
...
const TABS: Tool[] = [
  t({
    ...
    inputSchema: { type: 'object', properties: {} }, annotations: { readOnlyHint: true },
    async handler(_a, ctx) { return jsonResult(await ctx.bridge.call('listTabs')); },
  }),
  t({
    ...
    async handler(args, ctx) { return textResult(`Opened tab${args.url ? ' → ' + args.url : ''}.`); },
  }),
  t({
    ...
    async handler(args, ctx) { return textResult(`Closed tab ${args.tabId}.`); },
  }),
];
...
const SYSTEM: Tool[] = [
  t({
    ...
    inputSchema: { type: 'object', properties: {} }, annotations: { readOnlyHint: true },
    async handler(_a, ctx) { return jsonResult({ agents: ctx.agents.connectedAgents().length, killSwitch: ctx.security.origin.isKillSwitchOn() }); },
  }),
  t({
    ...
    async handler(args) { return textResult(`Opened ${args.section}.`); },
  }),
];
