...
export const AVAILABLE_SKILLS: SkillMeta[] = [
  ...
  { id: 'analysis', label: 'Deep Analysis & Evaluation', description: 'Analyze, compare, break down, assess, SWOT, evaluate data, documents, or code', patterns: /\b(analyze|analysis|compare|comparison|evaluate|evaluation|break\s*down|swot|pros?.*cons?|assessment|review|verdict|criteria)\b/i, icon: '📊' },
  { id: 'finance', label: 'Stock & Financial Analysis', description: 'Stock quotes, market research, crypto, forex, company financials, investment analysis', patterns: /\b(stock|stocks|market|investing|trading|crypto|bitcoin|ethereum|forex|symbol|pe\s*ratio|market\s*cap|revenue|earnings|dividend|ipo|shares?|nasdaq|nyse|nse|bse|sensex|nifty)\b/i, icon: '💰' },
  ...
  { id: 'tab-intelligence', label: 'Tab Intelligence', description: 'Tab analysis, summarization, grouping, comparison, cross-tab search, and research context', patterns: /\b(tabs?|analyse? tabs?|analyze? tabs?|open tabs?|my tabs?|tab group|organize tabs?|summarize? tabs?|tab content|tab research|find in tabs?)\b/i, icon: '📑' },
