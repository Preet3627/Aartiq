export const shortcutDefinitions = [
    ...
    { action: 'command-center', label: 'Command Center', category: 'AI', accelerator: 'CommandOrControl+K' },
    { action: 'focus-ai-prompt', label: 'Focus AI Prompt', category: 'AI', accelerator: 'CommandOrControl+L' },
    { action: 'toggle-autonomous', label: 'Toggle Autonomous Mode', category: 'AI', accelerator: 'CommandOrControl+Shift+A' },
