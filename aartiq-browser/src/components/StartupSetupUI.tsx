              ...
              >
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  >
                    ...
                    <h3 className="mt-5 text-xl font-semibold tracking-[-0.02em]">Use Aartiq</h3>
            ...
            {step === 4 && (
              ...
              >
                <div>
                  ...
                  <h3 className="mt-2 text-2xl font-semibold tracking-[-0.03em]">You are ready to open Aartiq.</h3>
                </div>
